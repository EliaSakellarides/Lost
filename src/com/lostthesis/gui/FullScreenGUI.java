...
public class FullScreenGUI extends JFrame {
    ...
    private void showIntroImages(String playerName) {
        ...
        final Image[] airplaneImage = {null};
        try {
            File imgFile = new File("assets/images/areo scena iniziale.jpg");
            if (imgFile.exists()) {
                airplaneImage[0] = javax.imageio.ImageIO.read(imgFile);
            }
        } catch (Exception e) {
    ...
    private void showHostessScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/hostess.jpg");
                    if (!imgFile.exists()) {
                        imgFile = new File("assets/images/hostess.png");
                    }
                    if (imgFile.exists()) {
                        hostessImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    hostessImage = null;
                }
    ...
    private void showTurbulenceScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/aereotrema.jpg");
                    if (imgFile.exists()) {
                        turbulenceImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    turbulenceImage = null;
                }
            }
    ...
    private void showPlaneBreakingScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/aereo si rompe in volo.jpg");
                    if (imgFile.exists()) {
                        planeImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    planeImage = null;
                }
    ...
    private void showEyeOpeningScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/occhio aperto -2.jpg");
                    if (imgFile.exists()) {
                        eyeImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    eyeImage = null;
                }
    ...
    private void showJungleAwakeningScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/risveglio in giungla.jpg");
                    if (imgFile.exists()) {
                        jungleImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    jungleImage = null;
                }
    ...
    private void showFollowVincentScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/segui vincent.jpg");
                    if (imgFile.exists()) {
                        vincentImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    vincentImage = null;
                }
    ...
    private void showBeachCrashScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/aereo distrutto su spiaggia.jpg");
                    if (imgFile.exists()) {
                        crashImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    crashImage = null;
                }
    ...
    private void showHelpSurvivorsScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/aiuto spravvissuti.jpg");
                    if (imgFile.exists()) {
                        helpImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    helpImage = null;
                }
    ...
    private void showHealWoundedScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/curare feriti.jpg");
                    if (imgFile.exists()) {
                        healImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    healImage = null;
                }
    ...
    private void showUseAlcoholScene(String playerName) {
        ...
        JPanel imagePanel = new JPanel() {
            ...
            {
                try {
                    File imgFile = new File("assets/images/curarsi con alchol.jpg");
                    if (imgFile.exists()) {
                        alcoholImage = javax.imageio.ImageIO.read(imgFile);
                    }
                } catch (Exception e) {
                    alcoholImage = null;
                }
